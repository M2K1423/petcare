    ...
    <article class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
        <div class="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex flex-wrap items-center gap-2">
                ...
                <button id="btn-filter-appointments" class="rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-semibold text-gray-700 hover:bg-gray-50">Xem</button>
                <button id="btn-today-appointments" class="rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-semibold text-gray-700 hover:bg-gray-50">Hôm nay</button>
                <button id="btn-refresh-appointments" class="text-sm text-blue-600 hover:text-blue-800"><i class="fas fa-sync-alt"></i> Làm mới</button>
            </div>
        </div>

        <div id="appointments-container" class="flex flex-col gap-3">
            <div class="rounded-xl bg-gray-50 p-4 text-center text-sm text-gray-500">Đang tải...</div>
        </div>
    </article>
