<x-layout.app
    title="Thanh toán & hóa đơn | {{ config('app.name', 'PetCare') }}"
    ...
    <div class="grid grid-cols-1 gap-6">
        <article class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <div id="medicine-orders-container" class="space-y-4">
                <div class="rounded-xl bg-gray-50 p-4 text-center text-sm text-gray-500">Đang tải đơn thuốc...</div>
            </div>
        </article>
        ...
        <article class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <div id="unpaid-container" class="space-y-3">
                <div class="rounded-xl bg-gray-50 p-4 text-center text-sm text-gray-500">Đang tải hóa đơn chưa thanh toán...</div>
            </div>
        </article>
    </div>
