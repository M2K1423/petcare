...
>
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-500">Confirm medicine orders, create payments, collect money, and process unpaid medical bills.</p>
    </div>

    <div class="grid grid-cols-1 gap-6">
        <article class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            <h2 class="mb-4 text-lg font-bold text-gray-900">Medicine Orders</h2>
            <div id="medicine-orders-container" class="space-y-4">
                <div class="rounded-xl bg-gray-50 p-4 text-center text-sm text-gray-500">Loading medicine orders...</div>
            </div>
        </article>

        <article class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            <h2 class="mb-4 text-lg font-bold text-gray-900">Unpaid Bills</h2>
            <div id="unpaid-container" class="space-y-3">
                <div class="rounded-xl bg-gray-50 p-4 text-center text-sm text-gray-500">Loading unpaid bills...</div>
            </div>
        </article>
    </div>
        ...
        <div class="flex min-h-screen items-end justify-center px-4 pb-20 pt-4 text-center sm:block sm:p-0">
            ...
            <div class="inline-block transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6 sm:align-middle">
                ...
                <form id="payment-form" class="mt-5 sm:mt-6">
                    ...
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700">Amount Paid (VND)</label>
                        <input type="number" step="0.01" id="amount" name="amount" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500 sm:text-sm" required>
                    </div>
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700">Payment Method</label>
                        <select id="payment_method" name="payment_method" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500 sm:text-sm">
