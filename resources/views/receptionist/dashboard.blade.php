    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <article class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm col-span-2">
            ...
            <div id="queue-container" class="mt-4 flex flex-col gap-3">
                <div class="p-4 text-center text-sm text-gray-500 bg-gray-50 rounded-xl">Đang tải hàng chờ...</div>
            </div>
        </article>
        ...
        <article class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <div id="doctors-container" class="mt-4 flex flex-col gap-3">
                <div class="p-4 text-center text-sm text-gray-500 bg-gray-50 rounded-xl">Đang tải bác sĩ...</div>
            </div>
        </article>
    </div>
